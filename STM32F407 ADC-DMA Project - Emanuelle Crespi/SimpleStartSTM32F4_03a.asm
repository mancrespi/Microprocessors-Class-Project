@;SimpleStartSTM32F4_03a.asm wmh 2015-05-13 : adds the entire device-specific interrupt vector table and stubs for same from "startup_stm32f407xx.s"
...
Reset_Handler:				@; @; start-from-reset code; initialize hardware and system data, launch main()
	@; initialize .data snd .bss is skipped
...
PendSV_Handler:
	b .	@;trap here
	.thumb_func
Default_Handler:	@;destination for all the other unimplemented interrupts or exceptions
	b .	@;trap here
